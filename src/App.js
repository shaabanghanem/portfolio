...
const PORTFOLIO_DATA = {
  personalInfo: {
    ...
    // 📸 روابط صورك (البروفايل ونبذة عنك)
  ...
  software: [
    ...
    },
    {
      id: 6,
      name: 'Microsoft apps',
      logo: 'https://i.postimg.cc/RFbMDm0t/New-Icons-Microsoft-365.png',
    },
  ],
  clients: [
  ...
  projects: [
    ...
    {
      id: 2,
      title: 'Lumina Cosmetics Campaign',
    ...
    {
      id: 3,
      title: 'Nexus Smart Home Profile',
    ...
    {
      id: 4,
      title: 'Onyx Architecture Exhibition',
      category: 'Posters',
      image:
    ...
    {
      id: 6,
      title: 'Tech Summit 2026 Keynote',
      category: 'Presentations',
      image:
        'https://images.unsplash.com/photo-1540317580384-e5d43867caa6?q=80&w=1600&auto=format&fit=crop',
    },
  ],
};
...
const Floating3DShapes = () => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden perspective-1000">
      ...
      <div
        className="absolute w-56 h-56 rounded-full border-[30px] border-white/10 dark:border-[#00ff87]/20 shape-material anim-3d-3"
...
export default function App() {
  ...
  // دالة التمرير الأفقي لمعرض الأعمال
  ...
  const stretchFactor = Math.min(
    Math.max(1 + Math.abs(scrollVelocity) * 0.0015, 1),
    1.15
  );
  const glassCard =
    'bg-white/40 dark:bg-[#0a0a0c]/60 backdrop-blur-2xl border border-white/50 dark:border-white/5 shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] rounded-3xl';

  return (
    <div
      className={`min-h-screen transition-colors duration-700 ease-in-out ${
        isDark ? 'bg-[#050505] text-gray-200' : 'bg-[#f0f0f5] text-gray-800'
    ...
    >
      ...
      <Floating3DShapes />
      <div
        className={`fixed inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] ${
          isDark
            ? 'from-[#00ff87]/5 via-[#050505] to-[#050505]'
            : 'from-[#00ff87]/20 via-[#f0f0f5] to-[#f0f0f5]'
        }`}
      ></div>
      ...
      <main className="relative z-10">
        ...
        >
          <div className="container mx-auto max-w-5xl text-center">
            ...
            >
              Design that <span className="italic font-light">speaks</span>{' '}
              <br />
              <span
                style={{
                  color: vibrantEmerald,
                  textShadow: isDark ? '0 0 40px rgba(0,255,135,0.4)' : 'none',
                }}
              >
                Volume.
              </span>
          ...
          <div className="relative group w-full max-w-[100vw]">
            ...
            >
              ...
              {filteredProjects.length === 0 && (
                <div className="w-full text-center py-32 text-gray-500 font-light text-xl">
                ...
                <div
                  ...
                  ${
                    isDark
                      ...
                      : 'bg-white/40 border border-white/50 shadow-[inset_2px_2px_15px_rgba(255,255,255,0.5),_0_10px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_15px_40px_rgba(0,255,135,0.2)] hover:border-[#00ff87]/50'
                  } backdrop-blur-xl`}
                >
                  ...
                  <div className="flex flex-wrap gap-2 md:gap-3 relative z-10">
                    {PORTFOLIO_DATA.skills.map((skill, i) => (
                      <span
                        ...
                        } hover:border-[#00ff87] transition-colors cursor-default`}
                      >
                        {skill}
                      </span>
                    ))}
              ...
              <div className="relative h-[400px] md:h-[600px] w-full rounded-3xl md:rounded-[2.5rem] overflow-hidden group shadow-2xl">
                <div
                  className={`absolute inset-0 bg-gradient-to-tr ${
                    isDark
                      ? 'from-[#00ff87]/40 to-transparent'
                      : 'from-[#00ff87]/30 to-transparent'
                  } z-10 mix-blend-overlay group-hover:opacity-0 transition-opacity duration-700`}
                ></div>
                <img
                  src={PORTFOLIO_DATA.personalInfo.aboutImage}
                  alt="Workspace or Portrait"
          ...
          <div className="container mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <span
                style={{
                  color: vibrantEmerald,
                  textShadow: isDark ? '0 0 30px rgba(0,255,135,0.3)' : 'none',
                }}
              >
                Iconic.
              </span>
            ...
            >
              ...
              <a
                href={`tel:${PORTFOLIO_DATA.personalInfo.phone.replace(
                  /\s/g,
                  ''
                )}`}
